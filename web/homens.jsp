...
<html>
    ...
    <body>
        ...
        <% try {
                ...
                listaSubCateg = persistencia.SubCategoriaDAO.getSubCategoriasHomens();
        %>

        <div id="homens_subcategorias">

            <%  Integer i = 1;
                for (SubcategoriaEntidade S : listaSubCateg) {// CRIANDO COLUNAS SUBCATEGORIAS
                    String palavra = "hom_sub_0" + i.toString();
            %>
        ...
        <div id="homens_conteudo">


            <% Integer s = 11;//id do iten
            Integer col =1;
                for (SubcategoriaEntidade Sub : listaSubCateg) {//CRIANDO AS COLUNAS COM OS ITENS
                    String nome = "homens_col_0" + col.toString();
                    
                    listaItens = persistencia.ItensSubcategoriaDAO.getIntensSubCategoriasPorId(2, s);
            %>
