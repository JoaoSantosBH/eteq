                                            ...
                                            <div id="a8">
                                                ...
                                                <%} else {%>
                                                    <div class="mensagens_painel" >
                                                        ...
                                                        <form name="form1resp" method="POST" action="RespostasDoaServlet">
                                                        ...
                                                        <form method="POST" action="CancelarDoacaoServlet">
                                                            <input type="hidden" name="id_forum" value="<%= idForum%>"/>
                                                            <input type="submit" class="btn-cad"  value="cancelar doacao" onclick="return confirm('Confirma cancelamento ?')"/>
                                                        </form>
                                                        <form method="POST" action="FinalizarDoacaoServlet">
                                                            <input type="hidden" name="id_forum" value="<%= idForum%>"/>
                                                            <input type="submit" class="btn-cad" value="finalizar doacao" onclick="return confirm('Confirma doacao finalizada ?')"/>
                                                        </form>
                                                        <%}%>
                                                    </div>
