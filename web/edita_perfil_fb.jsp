...
<!--                </div>-->
            ...
            <div id="col3_cadastro_pessoal">
                <form name="form1" action="EditarPerfiFacebookServlet" method="post" >

                    <input size="32" placeholder="LOGRADOURO" type="text" name="txt_logradouro" maxlength="45" /> <br/>
                    ...
                    <input size="32" placeholder="CEP" type="text" name="txt_cep"  maxlength="9" onkeypress="mascara(this, '#####-###')" /> <br/>
