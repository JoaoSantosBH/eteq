<%-- 
    Document   : resultado_lista
    Created on : Apr 19, 2014, 2:58:31 PM
    Author     : joaosantos
--%>
...
<html>
    ...
    <%
        ...
        String idItensSub = request.getParameter("id_itens_sub");

        List<PatrimonioEntidade> lst = ControladorPatrimonio.pegarItensDaSubCategoria(idCat, idItensSub);
        if (Erro == null) {
            Erro = "";
        }
                                        ...
                                        <div id="a7">
                                            <div id="a8">
                                                ...
                                                <div id="i0" class="page">
                                                    ...
                                                    <% if (lst.size() == 0) { %>
                                                    <div id="troca"> 
                                                        <img src="img/error_notfound.png" style="left: 35%;position: absolute;"/>
                                                    </div>
                                                    <%}%>
