...
<html>
    <head>
        ...
        <%
            ...
            String idPatTem = request.getParameter("idPatTem");
            String idUsuario = "";
            if (Logado != null) {
                idUsuario = Logado.getIdUsuario().toString();
            }

            ArrayList<PatrimonioEntidade> lst = new ArrayList<PatrimonioEntidade>();
            lst = controle.ControladorNegociacao.perguntarPorQualItemDesejaRealizarTrocaComUsuarioTem(idUsuario);
        ...
        <script>
            function validarTroca() {
                ...
                if (exibir == "") {
                    window.alert("Escolha um item para a troca.");
                                            ...
                                            <div id="a7">
                                                <div id="a8">
                                                    ...
                                                    <div id="i0" class="page">
                                                        ...
                                                        <div id="cadastro">
                                                            Por favor selecione um item seu para propor a troca!
                                                            ...
                                                            <form name="formTrocar" action="TrocarServlet" method="POST" >
                                                                ...
                                                                <%if (p.getTipo() == 1 && p.getReservado() == 0) {%>
                                                                    <option value="<%=p.getIdPatrimonio() %>"> <%= p.getTitulo()%> </option>
                                                                ...
                                                                <input type="hidden" name="id_usuario_quer" value="<%= Logado.getIdUsuario().toString()%>"/>
                                                                <input type="hidden" name="id_pat_tem" value="<%= idPatTem%>"/>
