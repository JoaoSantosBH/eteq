...
<html>
    ...
    <body>
        ...
        <% try {
                ...
                listaSubCateg = persistencia.SubCategoriaDAO.getSubCategoriasOutros();
        %>

        <div id="outros_subcategorias">

            <%  Integer i = 1;
                for (SubcategoriaEntidade S : listaSubCateg) {// CRIANDO COLUNAS SUBCATEGORIAS
                    String palavra = "out_sub_0" + i.toString();

                    if (i >= 10 ) {
                        palavra = "out_sub_" + i.toString();
        ...
        <div id="outros_conteudo">


            <% Integer s = 40;//id do iten
            Integer col = 1;
                for (SubcategoriaEntidade Sub : listaSubCateg) {//CRIANDO AS COLUNAS COM OS ITENS
                    String nome = "outros_col_0" + col.toString();
                    if (s == 10) {
                        nome = "outros_col_" + col.toString();
                    }
                    listaItens = persistencia.ItensSubcategoriaDAO.getIntensSubCategoriasPorId(6, s);
            %>
