                                            ...
                                            <div id="a8">
                                                ...
                                                <div id="i0" class="page">
                                                    ...
                                                    <div id="div_historico">
                                                        ...
                                                        <% if (Logado != null) {
                                                                ArrayList<HistoricoEntidade> lstH = controle.ControladorHistorico.visualizarMeuHistoricodeAnuncios(Logado.getIdUsuario().toString());%>
                                                        <% for (HistoricoEntidade h : lstH) {
                                                                p = new PatrimonioEntidade();
                                                                p = PatrimonioDAO.pegarPatrimonioPorId(h.getIdPatrimonioTem().toString());
                                                                if(p.getIdUsuario() != Logado.getIdUsuario()){
                                                                    p = PatrimonioDAO.pegarPatrimonioPorId(h.getIdPatrimonioQuis().toString());
                                                                }
                                                        ...
                                                        <div style="position: relative;left: 30px; top: 10px;border: 1px; border-bottom-style: dashed;">
                                                            ...
                                                            <img src="<%= p.getFoto()%>" width="45" height="45"/>
                                                            <h2><%= p.getTitulo()%></h2>  
                                                            <%= h.getStatus()%> em: <%= fronteira.FormataDataHtml.formatarDataParaDisplay(h.getDataDesativacao().toString())%>
