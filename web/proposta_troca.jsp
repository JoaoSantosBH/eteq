...
<html>
    ...
    <%
        ...
        String idNegociacao = request.getParameter("id_negocio");

        NegociacaoEntidade n = ControladorNegociacao.pegarNegociacaoPeloId(idNegociacao);

        String nomeProponente = "";
        if (Logado != null) {
            nomeProponente = ControladorUsuario.pegarNomeProponenteTroca(n.getIdUsuarioQuer().toString());
        }
                                        ...
                                        <div id="a7">
                                            <div id="a8">
                                                ...
                                                <div id="i0" class="page">
                                                    ...
                                                    if ( !negocioJaFoiAceito && ehMeu) {%>

                                                    <div id="propTroca">


                                                        OI <%=Logado.getNome()%></br>
                                                        <%=nomeProponente%> deseja trocar (o/a)
                                                        </br>
                                                        <img src="<%=patQuer.getFoto()%>" width="140" height="140"> </br><%=patQuer.getTitulo()%></br>

                                                    </div>

                                                    <div id="propTroca2">
                                                        pelo seu(sua)  <%=patTem.getTitulo()%></br>

                                                        <img src="<%=patTem.getFoto()%>" width="140" height="140">

                                                    </div>
                                                    <div id="propTroca03">
                                                        <form method="POST" action="AceitarTrocaServlet">
                                                            <input type="hidden" name="txt_id_negocio" value="<%=idNegociacao%>"/>
                                                            <input type="submit" value="Aceitar" class="btn-cad"/>
                                                        </form>
                                                        <form method="POST" action="NaoAceitarTrocaServlet">
                                                            <input type="hidden" name="txt_id_negocio" value="<%=idNegociacao%>"/>
