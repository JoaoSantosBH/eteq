<%-- 
    Document   : produto_aprova
    Created on : Apr 29, 2014, 2:18:36 PM
    Author     : joaosantos
--%>
                                            ...
                                            <div id="a7">
                                                <div id="a8">
                                                    ...
                                                    <div id="i0" class="page">
                                                        ...
                                                        <%} else if(Logado.getNome().equals(admin)){%>

                                                        <div id="troca">
                                                            <img src="<%= p.getFoto()%>" width="180" height="180">
                                                            <pre><%= p.getTitulo()%></pre>
                                                            <%= p.getDescricao()%>
                                                            <form method="POST" action="AprovarPatrimonioServlet">
                                                            ...
                                                            <form method="POST" action="NaoAprovarPatrimonioServlet">
