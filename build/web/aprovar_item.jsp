...
<html>
    ...
    <%
        ...
        List<PatrimonioEntidade> lst = ControladorPatrimonio.buscarPatrimoniosParaAprovacao();
        if (Erro == null) {
            Erro = "";
        }
                                                    ...
                                                    <div class="wrapper">
                                                        ...
                                                        <div class="image_carousel"> 
                                                            <div id="foo4">
                                                                ...
                                                                <a  href="produto_aprova.jsp?idProd=<%=p.getIdPatrimonio()%>"><img src="<%=p.getFoto()%>" width="140" height="140"/>
                                                                    <br/>
                                                                    <h3><%=p.getTitulo()%></h3>
                                                                </a>
