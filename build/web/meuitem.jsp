                                            ...
                                            <div id="a7">
                                                <div id="a8">
                                                    ...
                                                    <jsp:include page="login.jsp">
                                                        ...
                                                        <%} else if (p.getIdPatrimonio() == null) {%>

                                                        <div id="meuitem">
                                                            <% if(msg.equals("1")){ %>
                                                            <h1 style="color: green;">ITEN EXCLUIDO COM SUCESSO</h1>
                                                            ...
                                                            <% if(msg.equals("2")){ %>
                                                            <h1 style="color: red;">ESTE ITEM ESTA SENDO NEGOCIADO! PARA EXCLUIR DEVE SER FINALIZADA SUA NEGOCIACAO</h1>
                                                            <form action="itens.jsp">
                                                                <input type="submit" value="voltar" class="btn-cad"/>
                                                            </form>
                                                            <%}%>                                                            
                                                        ...
                                                        <%} else {
                                                            ...
                                                            int valor = ControladorPatrimonio.pegarAtributoAvisado(p.getIdPatrimonio().toString());%>

                                                        <div id="meuitem">
                                                            <img src="<%= p.getFoto()%>"><% if (valor != 0) { %><h2 style="color: #ff6666;">Anuncio Vencido!</h2> <%}%>

                                                            <h1><%= p.getTitulo()%></h1>
                                                        </div>
                                                        <div id="meuitem2">
                                                            <%= p.getEstadoConservacao()%>
                                                            </br><%= p.getDescricao()%></br>
                                                            <form method="POST" action="ExcluirPatrimonioServlet">

                                                                <input type="hidden" name="id_usuario" value="<%= Logado.getIdUsuario().toString()%>"/>
                                                                <input type="hidden" name="id_produto" value="<%= idProduto%>"/>
                                                                <input type="submit" value="excluir" onclick="return confirm('Confirma exclusao ?')" class="btn-cadexc"/>
                                                            </form>

                                                            <!-- Se estiver expirado -->
                                                            <% if (valor != 0) {%>
                                                            <form method="POST" action="RenovarCadastroPatrimonioServlet">

                                                                <input type="hidden" name="id_usuario" value="<%= Logado.getIdUsuario().toString()%>"/>
                                                                <input type="hidden" name="id_produto" value="<%= idProduto%>"/>
                                                                <input type="submit" value="renovar" class="btn-cad1"/>
                                                            </form>
                                                            <%}%>
                                                            <!-- Se estiver expirado -->

                                                            <form method="POST" action="editar_patrimonio.jsp?idProd=<%= idProduto%>">
                                                            ...
                                                            <form action="itens.jsp">
                                                                <input type="submit" value="voltar" class="btn-cad1" />
                                                            </form>    
                                                        </div>
