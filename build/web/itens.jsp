                                        ...
                                        <div id="a7">
                                            <div id="a8">
                                                ...
                                                <div id="i0" class="page">
                                                    ...
                                                    <%}%>
                                                    <% if (Logado != null) {
                                                            List<PatrimonioEntidade> lst = ControladorPatrimonio.listarMeusIntens(Logado.getIdUsuario().toString());%>
                                                    ...
                                                    <div class="wrapper">
                                                        ...
                                                        <div class="image_carousel"> 
                                                            <div id="foo4">
                                                                ...
                                                                <a  href="meuitem.jsp?idProd=<%=p.getIdPatrimonio()%>"><img src="<%=p.getFoto()%>" width="140" height="140"/>
