<%-- 
    Document   : around
    Created on : May 27, 2014, 4:51:38 PM
    Author     : joaosantos
--%>
...
<html>
    ...
    <%
        ...
        List<PatrimonioEntidade> lst = ControladorPatrimonio.procurarPatrimonio(palavra);
        if (Erro == null) {
            Erro = "";
        }
                                            ...
                                            <div id="a8">
                                                ...
                                                <div id="i0" class="page">
                                                    ...
                                                    <% if (Logado != null) {
                                                            ...
                                                            int cidade = EnderecoDAO.pegarCidadeUsuario(Logado.getIdUsuario().toString());
                                                        
                                                            if (cidade == 0) {%>

                                                    <div id="troca"> 
                                                        <a href="editar_perfil.jsp"><img src="img/around_fb.png" style="left: 35%;position: absolute;"/> </a>
                                                    </div>

                                                    <% } else {%>
                                                    
                                                    <jsp:include page="google_maps.jsp">
