...
<%@page import="entidade.HistoricoEntidade"%>
                                            ...
                                            <div id="a8">
                                                ...
                                                <div id="i0" class="page">
                                                    ...
                                                    <div id="div_historico">
                                                        ...
                                                        <form name="form1" method="POST" action="ExcluirPerfilUsuarioServlet">

                                                            <input type="text"  placeholder="DIGITE SUA SENHA" name="txt_senha">
                                                            <input name="id_usuario" type="hidden" value="<%= Logado.getIdUsuario().toString()%>"/>


                                                            <input type="submit" value="APAGAR PERFIL" class="btn_salvar" onclick="return validar()"/>
                                                            <!--<input type="submit" value="APAGAR PERFIL" onclick="return confirm('Confirma exclusao ?')"/>-->
                                                        </form>

                                                        <% if (msg.equals("1")) { %>
                                                        <h2 style="color: red;">VOCE POSSUI UMA RESERVA EM SEU NOME! PARA EXCLUIR O SEU PERFIL TERMINE SUA NEGOCIACAO!</h2>
                                                        <%} else %>
                                                        <% if (msg.equals("2")) { %>
                                                        <h2 style="color: red;">A SENHA DIGITADA NAO CONFERE!</h2>
                                                        <%}%>
