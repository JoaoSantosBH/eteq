<%-- 
    Document   : aprovar_foto
    Created on : Apr 29, 2014, 4:11:42 PM
    Author     : joaosantos
--%>
...
<html>
    ...
    <%
        ...
        List<UsuarioEntidade> lst = ControladorUsuario.pegarFotosParaAprovacao();
        if (Erro == null) {
            Erro = "";
        }
                                        ...
                                        <div id="a7">
                                            <div id="a8">
                                                ...
                                                <div id="i0" class="page">
                                                    ...
                                                    <% if (lst.size() == 0 && Logado != null && Logado.getNome().equals(admin)) { %>
                                                    <div id="troca">
                                                        <img src="img/error_itens_aprov.png" style="left: 35%;position: absolute;"/></div>
                                                    <%}%>
                                                    <% if (Logado == null) { %>
                                                    ...
                                                    <div class="wrapper">
                                                        ...
                                                        <div class="image_carousel"> 
                                                            <div id="foo4">
                                                                    ...
                                                                    <% for (UsuarioEntidade u : lst) {%>


                                                                    <a  href="foto_aprova.jsp?idUsuario=<%=u.getIdUsuario()%>"><img src="<%= u.getFoto()%>" width="140" height="140"/>
                                                                        <br/>
                                                                        <h3><%= u.getNome()%></h3>
                                                                    </a>
