<%-- 
    Document   : foto_aprova
    Created on : Apr 29, 2014, 4:31:05 PM
    Author     : joaosantos
--%>
...
<html>
    <head>
        ...
        <%
            ...
            UsuarioEntidade e = new UsuarioEntidade();
            e = ControladorUsuario.pegarUsuario(idUsuario);
                                                ...
                                                <div id="a8">
                                                    ...
                                                    <div id="i0" class="page">
                                                        ...
                                                        <div id="troca">
                                                            ...
                                                            <div id="troca">
                                                                <img src="<%= e.getFoto()%>" width="180" height="180">
                                                                <pre><%= e.getNome()%></pre>

                                                                <form method="POST" action="AprovarFotoServlet">

                                                                    <input type="hidden" name="id_usuario" value="<%= idUsuario%>"/>

                                                                    <input type="submit" value="aprovar" class="btn-cad"/>
                                                                </form>

                                                                <form method="POST" action="NaoAprovarFotoServlet">

                                                                    <input type="hidden" name="id_usuario" value="<%= idUsuario%>"/>

                                                                    <input type="submit" value="reprovar" class="btn-cad"/>
                                                                </form>
