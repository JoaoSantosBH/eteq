 ...
 * @author joaosantos
 */
public class SolicitarDoacaoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Boolean tenhoReserva = ControladorUsuario.verificarSeUsuarioPossuiReserva(idUsuQuer);
                Boolean ehMeu = ControladorPatrimonio.verificarSeProponmenteDonoPatrimonio(idPatTem, idUsuQuer);
                
                if(ehMeu){
                    response.sendRedirect("produto.jsp?msg=1");
                } else{
                    if (!tenhoReserva) {
                    
                  
                        controle.ControladorNegociacao.solicitarDoacaoDePatrimonio(idUsuQuer, idPatTem);
                        response.sendRedirect("produto.jsp?msg=3");
                    ...
                    response.sendRedirect("produto.jsp?msg=2");
                }
                }
