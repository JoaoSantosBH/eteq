 ...
 * @author joaosantos
 */
public class ParametrosFotoPatrimonioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            /* TODO output your page here. You may use following sample code. */
                       String largura = request.getParameter("txt_largurapat");
            String altura = request.getParameter("txt_alturapat");
            String idAlt = request.getParameter("id_altfotopat");
            String idLarg = request.getParameter("id_largfotopat");
